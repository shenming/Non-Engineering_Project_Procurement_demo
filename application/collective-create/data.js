/**
 * 联合招采（跨企业）— 创建模式数据配置
 * 与单次招采数据配置结构相同，但数据内容可独立定制。
 * 
 * 说明：联合招采支持从多企业选择计划项，采购方式应统一。
 * 以下数据为示例数据，请根据实际业务调整。
 */
...
var DETAIL_DATA = {
    '公开招标': {
        info: {
            projectName: '集团年度物业服务（联合）',
            applyCode: 'ZL-2026-001',
            unit: '集团总部',
            status: '草稿',
            statusTag: 'tag-gray',
        },
        ...
        nodes: {
            0: {
                form: {
                    procCode: 'ZL-2026-001', procName: '集团年度物业服务（联合）', companyCode: 'HQ-001',
